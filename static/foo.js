...
function runShaderProgram(gl, program, width, height) {
...
function runShaderProgramToTexture(gl, program, width, height) {
...
function renderTextureToCanvas(gl, texture, canvas) {
